...
COMPONENTS.push(
  // API Reference
  {
    name: 'EndpointRequestSnippet',
    prefix: 'fern-endpoint-request',
    jsxForm: true,
    description: 'Embeds a generated code snippet for an API request.',
    props: [
      { name: 'endpoint', type: 'string', required: true, description: 'Endpoint in "METHOD /path" format, e.g. "POST /auth/token".' },
    ],
    example: '<EndpointRequestSnippet endpoint="POST /auth/token" />',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/endpoint-request-snippet',
    snippetBody: '<EndpointRequestSnippet endpoint="$1" />',
  },
  {
    name: 'EndpointResponseSnippet',
    prefix: 'fern-endpoint-response',
    jsxForm: true,
    description: 'Embeds a generated code snippet showing an API response.',
    props: [
      { name: 'endpoint', type: 'string', required: true, description: 'Endpoint in "METHOD /path" format.' },
    ],
    example: '<EndpointResponseSnippet endpoint="GET /users/{id}" />',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/endpoint-response-snippet',
    snippetBody: '<EndpointResponseSnippet endpoint="$1" />',
  },
  {
    name: 'EndpointSchemaSnippet',
    prefix: 'fern-endpoint-schema',
    jsxForm: true,
    description: 'Embeds a schema diagram for an API request or response body.',
    props: [
      { name: 'endpoint', type: 'string', required: true, description: 'Endpoint in "METHOD /path" format.' },
      { name: 'selector', type: 'string', required: false, description: 'Which schema to show.', choices: ['request', 'request.body', 'response', 'response.body'] },
    ],
    example: '<EndpointSchemaSnippet endpoint="POST /users" selector="request.body" />',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/endpoint-schema-snippet',
    snippetBody: '<EndpointSchemaSnippet endpoint="$1" selector="${2|request,request.body,response,response.body|}" />',
  },
  {
    name: 'RunnableEndpoint',
    prefix: 'fern-runnable-endpoint',
    jsxForm: true,
    description: 'Interactive API request builder readers can execute in the browser.',
    props: [
      { name: 'endpoint', type: 'string', required: true, description: 'Endpoint in "METHOD /path" format.' },
    ],
    example: '<RunnableEndpoint endpoint="GET /users" />',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/runnable-endpoint',
    snippetBody: '<RunnableEndpoint endpoint="$1" />',
  },
  {
    name: 'Schema',
    prefix: 'fern-schema',
    jsxForm: true,
    description: 'Displays a type definition from the API reference inline in the page.',
    props: [
      { name: 'type', type: 'string', required: true, description: 'Name of the type to render (must exist in your API spec).' },
    ],
    example: '<Schema type="User" />',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/schema',
    snippetBody: '<Schema type="$1" />',
  },
  {
    name: 'ParamField',
    prefix: 'fern-paramfield',
    jsxForm: true,
    description: 'Documents an API parameter with name, type, and description.',
    props: [
      { name: 'path', type: 'string', required: true, description: 'Parameter name (supports dot notation for nested fields, e.g. "user.email").' },
      { name: 'type', type: 'string', required: true, description: 'Parameter type.', choices: ['string', 'number', 'boolean', 'object', 'array'] },
    ],
    example: '<ParamField path="user.email" type="string">\n  The email address of the user.\n</ParamField>',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/param-field',
    snippetBody: '<ParamField path="$1" type="${2|string,number,boolean,object,array|}">\n  $3\n</ParamField>',
  },
  // Structure
  {
    name: 'Files',
    prefix: 'fern-files',
    jsxForm: true,
    description: 'Interactive file tree with collapsible folders and file icons.',
    props: [],
    example: '<Files>\n  <Folder name="src" defaultOpen>\n    <File name="index.ts" />\n    <File name="client.ts" />\n  </Folder>\n  <File name="package.json" />\n</Files>',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/files',
  ...
  },
  {
    ...
    prefix: 'fern-prompt',
    jsxForm: true,
    description: 'Copyable AI prompt card with "open in" actions for AI tools.',
    props: [
      { name: 'title', type: 'string', required: false, description: 'Heading shown above the prompt text.' },
      { name: 'actions', type: 'string[]', required: false, description: 'AI tools to show open-in buttons for.', choices: ['cursor', 'claude', 'chatgpt'] },
    ],
    example: '<Prompt title="Summarize this doc" actions={["cursor", "claude"]}>\n  Summarize the following API documentation in plain English.\n</Prompt>',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/prompt',
    snippetBody: '<Prompt title="$1" actions={["${2|cursor,claude,chatgpt|}"]}>\n  $3\n</Prompt>',
  },
  // Tables
  {
    name: 'Table',
    prefix: 'fern-table',
    jsxForm: false,
    description: 'Standard markdown pipe table (3 columns, 2 rows).',
    props: [],
    example: '| Name | Type | Description |\n|------|------|-------------|\n| id | string | Unique identifier |\n| email | string | User email address |',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/tables',
    snippetBody: '| $1 | $2 | $3 |\n|---|---|---|\n| $4 | $5 | $6 |\n| $7 | $8 | $9 |',
  },
  {
    name: 'StickyTable',
    ...
    jsxForm: true,
    description: 'Table with a sticky header row that stays visible while scrolling.',
    props: [],
    example: '<StickyTable>\n| Name | Type | Description |\n|------|------|-------------|\n| id | string | Unique identifier |\n</StickyTable>',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/sticky-table',
    snippetBody: '<StickyTable>\n| $1 | $2 | $3 |\n|---|---|---|\n| $4 | $5 | $6 |\n</StickyTable>',
  },
  {
    name: 'SearchableTable',
    prefix: 'fern-searchable-table',
    jsxForm: true,
    description: 'Table with a real-time search filter input above it.',
    props: [
      { name: 'placeholder', type: 'string', required: false, description: 'Placeholder text shown in the search input.' },
    ],
    example: '<SearchableTable placeholder="Search endpoints...">\n| Name | Method | Path |\n|------|--------|------|\n| List users | GET | /users |\n</SearchableTable>',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/searchable-table',
    snippetBody: '<SearchableTable placeholder="$1">\n| $2 | $3 | $4 |\n|---|---|---|\n| $5 | $6 | $7 |\n</SearchableTable>',
  },
  // Versioning
  {
    name: 'Versions',
    ...
    jsxForm: true,
    description: 'Shows different content based on the reader\'s selected version.',
    props: [],
    example: '<Versions>\n  <Version version="v2" title="v2 (Latest)" default>\n    Use the new `client.v2.users.list()` method.\n  </Version>\n  <Version version="v1" title="v1 (Legacy)">\n    Use the legacy `client.users.list()` method.\n  </Version>\n</Versions>',
    docUrl: 'https://buildwithfern.com/learn/docs/writing-content/components/versions',
    snippetBody: '<Versions>\n  <Version version="$1" title="$2" default>\n    $3\n  </Version>\n  <Version version="$4" title="$5">\n    $6\n  </Version>\n</Versions>',
  },
);
